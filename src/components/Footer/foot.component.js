        ...
        <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
            <div class="col-span-full lg:col-span-2">
              ...
              <p class="text-gray-400 sm:pr-8 mb-6 text-xs">
          ...
          <div class="text-gray-400 text-sm text-center border-t border-gray-800 py-4">
            © {new Date().getFullYear()} - Errands and Services. All rights
            reserved.
          </div>
        </footer>
      </div>
